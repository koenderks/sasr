...
![Figure 3.1: The location of planning stage in the audit sampling workflow](img/planning.png){fig-align="center"}

The standard audit sampling workflow consists of four stages: planning,
selection, execution, and evaluation. The planning stage is the first of these
stages.
