...
the prior distribution for the next item. However, to get an idea of how many
samples are required to achieve a certain amount of assurance, planning a sample
using a Bayesian approach can still be good practice.
:::
...
::: {.callout-note}
$\lceil...\rceil$ is the ceiling function. This means that $\lceil1.2\rceil = 2$.
:::
