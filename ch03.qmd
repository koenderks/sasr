...
![When the sampling objectives, the expected misstatements, and the likelihood are known, there is only one sample size that is optimal. Image available under a [CC-BY-NC 4.0](https://creativecommons.org/licenses/by-nc/4.0/legalcode) license.](img/book_puzzle.png){fig-align="center" width=75%}
