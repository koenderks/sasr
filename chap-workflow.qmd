...
![The standard audit sampling workflow consists of four stages: planning, selection, execution and evaluation.](./img/workflow.png){fig-align="center" width=75%}
...
![The planning stage is the first stage in the audit sampling workflow.](./img/workflow_planning.png){fig-align="center" width=75%}
...
![The selection stage is the second stage in the audit sampling workflow.](./img/workflow_selection.png){fig-align="center" width=75%}
...
![The evaluation stage is the final stage in the audit sampling workflow.](./img/workflow_evaluation.png){fig-align="center" width=75%}
