...
You can freely download JASP from their website [`https://jasp-stats.org`](https://jasp-stats.org). Simply click on the 'Download JASP' button on the homepage, and you will be taken to the download page. There, you can select your preferred installation option. JASP is compatible with Windows, MacOS, Linux, and Chrome OS. The installation process is straightforward and familiar. Once installed, open the software to see the welcoming screen displayed below.

![Upon launching JASP, you are presented with the following screen. The icons in the ribbon display a range of statistical analyses. The menu icon located in the top left corner conceals the most crucial user options. The plus icon situated in the top right corner conceals the modules.](img/JASP_welcome.png){fig-align="center" width=100%}
...
![The `+` icon displays all modules that are currently available in JASP. To activate a module and add it to the ribbon at the top of the screen, click on the checkbox next to it.](img/JASP_modules.png){fig-align="center" width=100%}
...
![By clicking the Audit module icon in the ribbon, you can view the various analyses that are included in the audit module.](img/JASP_audit_module.png){fig-align="center" width=100%}
...
![A snapshot of the classical planning analysis in JASP for Audit. In this analysis, the auditor is using the binomial likelihood, a sampling risk of 5 percent, a performance materiality of 3 percent and one expected misstatement in the sample. The resulting sample size is 157.](img/JASP_planning_classical.png){fig-align="center" width=100%}
...
![Snapshot of the Bayesian planning analysis in JASP for Audit. In this analysis, the auditor is using the Poisson likelihood with an impartial gamma prior, a sampling risk of 5 percent, a performance materiality of 10 percent and no expected misstatements in the sample. The resulting sample size is 24.](img/JASP_planning_bayesian.png){fig-align="center" width=100%}
...
![A snapshot of the selection analysis in JASP for Audit. In this analysis, the auditor is using a fixed interval monetary unit sampling method to select a sample of 60 monetary units from a population.](img/JASP_selection.png){fig-align="center" width=100%}
...
![A snapshot of the planning stage for this example in the sampling workflow analysis in JASP for Audit.](img/JASP_planning_workflow.png){fig-align="center" width=100%}
...
![A snapshot of the selection stage for this example in the sampling workflow analysis in JASP for Audit.](img/JASP_selection_workflow.png){fig-align="center" width=100%}
...
![A snapshot of the evaluation stage for this example in the sampling workflow analysis in JASP for Audit.](img/JASP_evaluation_workflow.png){fig-align="center" width=100%}
