...
![A snapshot of the classical planning analysis in JASP for Audit. In this analysis, the auditor is using the binomial likelihood, a sampling risk of 5 percent, a performance materiality of 3 percent and one expected misstatement in the sample. The resulting sample size is 157.](img/JASP_planning_classical.png){fig-align="center"}
...
![Snapshot of the Bayesian planning analysis in JASP for Audit. In this analysis, the auditor is using the Poisson likelihood with an impartial gamma prior, a sampling risk of 5 percent, a performance materiality of 10 percent and no expected misstatements in the sample. The resulting sample size is 24.](img/JASP_planning_bayesian.png){fig-align="center"}
...
![A snapshot of the planning stage for this example in the sampling workflow analysis in JASP for Audit.](img/JASP_planning_workflow.png){fig-align="center"}
...
![A snapshot of the selection stage for this example in the sampling workflow analysis in JASP for Audit.](img/JASP_selection_workflow.png){fig-align="center"}
...
![A snapshot of the evaluation stage for this example in the sampling workflow analysis in JASP for Audit.](img/JASP_evaluation_workflow.png){fig-align="center"}
