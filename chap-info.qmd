...
```{r}
binom.test(x = 0, n = 60, p = 1, alternative = "less",
           conf.level = 0.95)
```
...
The prior distribution and posterior distribution can be used to directly obtain the Bayes factor in favor of (in)tolerable misstatement.
