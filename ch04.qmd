...
This chapter outlines the most commonly used sampling methodology for auditing
...
`BuildIt` data set that can be loaded using the code below. For simplicity, we
will use a sample size of 10 for all examples.
...
![Figure 4.1: Illustration of random sampling](img/randomSampling.png)
...
![Figure 4.2: Illustration of fixed interval sampling](img/fixedIntervalSampling.png)
...
The sample can be reproduced in **jfa** via the following command. Note that, by
...
![Figure 4.3: Illustration of cell sampling](img/cellSampling.png)
...
the `decreasing = FALSE` (default) argument.
