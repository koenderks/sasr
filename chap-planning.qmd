...
an idea of how many samples are required to achieve a certain amount of
assurance, planning a sample using a Bayesian approach can still be good
practice.
...
sample size needed to achieve a certain level of assurance.
...
needed to achieve a certain level of assurance.
...
size needed to achieve a certain level of assurance.
...
calculated with the command below and is 102.
