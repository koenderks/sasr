...
The performance materiality for this example is set to $\theta_{max}$ = 5 percent, and the audit risk is set to $\alpha$ = 0.05, or 5 percent. By using this prior distribution, the required minimum sample size is $n$ = 50.
